...
- **Settings**: **Reverse Y axis** - this option should be selected so depths / ages run from young at the top to old at the bottom.  De-select if your chronology is years CE.  

- **Exaggeration**: Show an exaggerated shilouette, either in the **exaggeration colour** selected on the colour tab, or, if **Auto Col** is selected, a pale version of the shilouette colour.  The latter is useful if you groups of variables with different colour shilouettes. **Exag mult**. is the multiplier for the exaggerated curve.
